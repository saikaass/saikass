...
lista_canales = ["1032828730453807104"] #las ids de los canales de spam, puedes agregar infinitas usando una , y las ids entre comillas.

mensaje = """amigo, q sonso""" # aqui va la plantilla de tu servidor, la que se enviara a los canales.

token = "MTE4MDYwNzAwMDYzMjEwNzE0OQ.Gdx4l_.mjNnnNUquWNXk0yWwg50MonUfq8Mze6GsBrGj4" #el token de tu cuenta, ten cuidado con este, tu token no se usara para otra cosa mas que para el proposito de la herramienta
